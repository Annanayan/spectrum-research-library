    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'bullet', content: '🧠Deep Breathing Exercises: Try the <strong>4-7-8</strong> breathing technique, repeat this cycle 4–6 times. This practice helps calm your mind and reduces stress.', level: 2 },

          { type: 'bullet', content: 'Sit comfortably and close your eyes.', level: 3 },
          { type: 'bullet', content: 'Inhale slowly through your nose for <strong>4</strong> seconds.', level: 3 },
          { type: 'bullet', content: 'Hold your breath for <strong>7</strong> seconds.', level: 3 },
          { type: 'bullet', content: 'Exhale slowly through your mouth for <strong>8</strong> seconds.', level: 3 },
          ...
          { type: 'bullet', content: '🧠Journaling: Spend a few minutes each day writing about your feelings. This could be a simple log of what made you feel lonely, what you\'re grateful for, or any positive interactions you experienced. Journaling can help you process emotions and see your progress over time.', level: 2 },
       
          { type: 'paragraph', content: 'Creative Outlets:', level: 1 },
          { type: 'bullet', content: '🌟Art and Music: Expressing yourself through drawing, painting, or playing music can be a powerful way to work through difficult feelings. You don\'t need to be an expert—simply allowing your creativity to flow can provide emotional relief.', level: 2 },
        
          { type: 'bullet', content: '🌟Writing and Storytelling: Consider writing short stories, poems, or even personal essays about your experiences. Sharing your story in a safe space (like a supportive online forum) can not only help you feel less isolated but also inspire others facing similar challenges.', level: 2 },
     
          { type: 'bullet', content: '🌟Hobbies That Connect: Engage in hobbies that interest you—whether it\'s photography, cooking, or gardening—and look for local or online groups where you can share your work and get feedback. This is a great way to build connections with people who have similar passions.', level: 2 },
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'bullet', content: 'Maintain basic routines (sleep, diet, hydration, and physical activity) to support physical and emotional resilience.', level: 1 },
          { type: 'bullet', content: 'Practice mindful grounding exercises when feeling overwhelmed or anxious.', level: 1 },
          { type: 'bullet', content: '🧠Deep Breathing Exercises - Repeat this <strong>4-7-8</strong> cycle 4–6 times to calm your mind and reduces stress:', level: 2 },
          { type: 'bullet', content: 'Sit comfortably and close your eyes.', level: 3 },
          { type: 'bullet', content: 'Inhale slowly through your nose for <strong>4</strong> seconds.', level: 3 },
          { type: 'bullet', content: 'Hold your breath for <strong>7</strong> seconds.', level: 3 },
          { type: 'bullet', content: 'Exhale slowly through your mouth for <strong>8</strong> seconds.', level: 3 },
