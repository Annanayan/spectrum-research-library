      ...
      <div className="container-xxl pt-16 pb-24">
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div className="space-y-6">
            <div className="footer-icons icon-gray flex items-center gap-5">
            ...
            <div className="footer-small footer-pink">
              <div>Contact:</div>
              <div><span>nmgwhmly@gmail.com</span></div>
            </div>
          </div>

          {/* 中列：介绍（粉色，不加粗） */}
          <div>
            <p className="footer-small footer-pink">
              Spectrum Research Library is dedicated to advancing LGBTQ+ knowledge, providing accessible resources,
              and supporting communities through research-based insights.
            </p>
          </div>
